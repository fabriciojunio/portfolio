...
const pt: Textos = {
  ...
  sobre: {
    ...
    longBio: [
      "Tenho 21 anos, curso Ciência da Computação na UNISAGRADO e trabalho na área de Serviços da Digihub, do grupo Lecom. A carteira é de treze clientes de seguros, saúde, cooperativismo de crédito, auditoria e judiciário.",
      ...
      "Isso virou o meu jeito de trabalhar: reproduzo a regra atual, rodo contra o histórico real e só confio no modelo quando ele acerta o passado. Numa correção recente foram 330 acertos em 331 processos antes de eu mudar uma linha.",
      "Nos projetos próprios o eixo é o mesmo. A Feira do Comando são três serviços em Spring Boot conversando por Kafka, com outbox transacional e saga que compensa. O Outorga leva a mesma disciplina para modelagem: a licença de exibição é invariante, e não existe caminho de código que publique sem ela.",
    ],
  },
  trabalho: {
    secao: "02 · trabalho",
...
const en: Textos = {
  ...
  sobre: {
    ...
    longBio: [
      "I am 21, studying Computer Science at UNISAGRADO, and I work in the Services team at Digihub, part of the Lecom group. The portfolio covers thirteen clients across insurance, healthcare, credit unions, auditing and the judiciary.",
      "My job is not starting systems from scratch. It is changing a live business process with hundreds of instances mid-flight at the moment the change ships. Java integrations and robots, screen rules in JavaScript, process routing and diagnostic SQL.",
      "That turned into how I work: I reproduce the current rule, run it against real history, and only trust the model once it gets the past right. On a recent fix that meant 330 correct out of 331 processes before I changed a single line.",
      "My own projects follow the same axis. Feira do Comando is three Spring Boot services talking over Kafka, with a transactional outbox and a saga that compensates. Outorga applies the same discipline to domain modelling: the broadcast licence is an invariant, and no code path can publish without one.",
    ],
  },
  trabalho: {
    secao: "02 · work",
...
const es: Textos = {
  ...
  sobre: {
    ...
    longBio: [
      "Tengo 21 años, estudio Ciencias de la Computación en UNISAGRADO y trabajo en el área de Servicios de Digihub, del grupo Lecom. La cartera son trece clientes de seguros, salud, cooperativas de crédito, auditoría y el poder judicial.",
      "Lo mío no es empezar sistemas desde cero. Es modificar un proceso de negocio vivo, con cientos de instancias en curso justo cuando el cambio sale. Integraciones y robots en Java, reglas de pantalla en JavaScript, ruteo de procesos y SQL de diagnóstico.",
      "Eso se volvió mi forma de trabajar: reproduzco la regla actual, la corro contra el historial real y solo confío en el modelo cuando acierta el pasado. En una corrección reciente fueron 330 aciertos de 331 procesos antes de cambiar una sola línea.",
      "Mis proyectos propios siguen el mismo eje. Feira do Comando son tres servicios en Spring Boot conversando por Kafka, con outbox transaccional y una saga que compensa. Outorga lleva la misma disciplina al modelado de dominio: la licencia de exhibición es un invariante, y no existe camino de código capaz de publicar sin ella.",
    ],
  },
  trabalho: {
    secao: "02 · proyectos",
